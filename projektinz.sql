...
(25, 21, 6, 'Iphone 14 pro max 64Gb', 'Uzywany iphone. w pelni sprawny ', '../uploads/pobrane.jpg', 3500, '2024-09-29 13:46:50', 27, 'active'),
...
(28, 22, 8, 'ibuprofen', 'tabletki na ból głowy ', '../uploads/pobrane (3).jpg', 132124, '2024-09-29 13:55:10', 26, 'active'),
...
(33, 24, 10, 'Ławka ogrodowa z Prawdziwego Drewna', 'ławka zrobiona z Dębowego drewna.', '../uploads/pobrane (5).jpg', 4000, '2024-09-29 14:41:46', 27, 'active'),
...
ALTER TABLE `reviews`
  ...
  ADD CONSTRAINT `reviews_ibfk_2` FOREIGN KEY (`id_auction`) REFERENCES `auctions` (`id_auction`);
